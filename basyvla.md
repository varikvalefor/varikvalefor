...
For all rows (of the table) $x$, the 3rd element of $x$ is the extent to which VARIK permits that the 1st element (of $x$) (which can be pronounced as the 2nd element (of $x$) or something) is used as the name of VARIK.
