...
\subsection{la'oi .\AgdaPostulate{\AgdaUnderscore{}cu-cafnysamflijinvi}.}
\paragraph{la .lojban.}
ni'o ga jo ctaipe la'o zoi.\ \B a \OpP{cu-cafnysamflijinvi} \B b\ .zoi.\ gi la'oi .\B{a}.\ jinvi lo du'u cafne fa lo nu samfli ri'a tu'a la'oi .\B{b}.\ samfli

\paragraph{English}
A proof of \B a \OpP{cu-cafnysamflijinvi} \B b\ exists iff \B a\ opines that frequent is that \B b\ crashes.

\begin{code}
postulate _cu-cafnysamflijinvi_ : ∀ {a} → {A : Set a} → Prenu → A → Set
\end{code}
...
postulate samflitolnei : {x : Samcmu}
                       → la-varik cu-cafnysamflijinvi x
                       → la-varik cu-tolnei x
\end{code}
...
\begin{code}
  postulate vistymasno : la-varik cu-cafnysamflijinvi la-vista
\end{code}
...
\begin{code}
  postulate openbysydys-samfli : la-varik cu-cafnysamflijinvi la-openbysydys
\end{code}
