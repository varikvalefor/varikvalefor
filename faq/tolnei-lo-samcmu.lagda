...
\begin{abstract}
\noindent
ni'o vasru le velcki be le ctaipe be le su'u la .varik.\ cu tolnei le samcmu be'o poi ke'a srana zo'e je le krinu / Contains definitions of proofs (of that VARIK dislikes operating systems) which are relevant to justifications and whatnot.
\end{abstract}
