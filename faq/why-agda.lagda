...
\begin{abstract}
\noindent
ni'o vasru le velcki be le ctaipe be le su'u la .varik.\ cu pilno la'oi .Agda.\ kei be'o poi ke'a srana le krinu je zo'e / The thing contains the definition of the proof (of that VARIK uses Agda) which is relevant to the justification and whatnot.
\end{abstract}
...
\paragraph{la .lojban.}
ni'o la .varik.\ na jinvi le du'u sarcu fa lo nu ciksi la'o zoi.\ \F{la-varik-cu-pilno-la'oi-Agda}\ .zoi.\ bau la .lojban.\sds  .i la .varik.\ cu stidi lo nu tcidu le torveki be bau la .lojban.\ fa lo ro prenu poi ke'a baupli la .lojban.\ je cu djica lo nu ke'a jimpe fi le ctaipe kei jenai cu jimpe fi le me'oi .Agda.\ velcki

\paragraph{English}
VARIK does-not find that necessary is that English is used for explaining \F{la-varik-cu-pilno-la'oi-Agda}.  VARIK suggests that for all prenu $A$, if $A$ uses English, then if $A$ desires that $A$ understands the proof, then if $A$ does-not understand the Agda definition, then $A$ reads the English summary.
