...
\paragraph{English}
VARIK does-not find that necessary is that English is used for explaining \F{la-varik-cu-pilno-la'oi-Agda}.  VARIK suggests that for all prenu $A$, if $A$ uses English, then if $A$ desires that $A$ understands about the proof, then if $A$ does-not understand about the Agda definition, then $A$ reads the English summary.
