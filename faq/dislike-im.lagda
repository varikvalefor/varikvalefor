...
\paragraph{English}
Contains descriptions of some instant messaging services, A.K.A.\ ``$A$'', and contains definitions of proofs of that (VARIK dislikes $A$) or that VARIK not likes $A$.
