...
VARIK knows that (some things claim that things should not use "ASPERGER's syndrome")... but identifies with "ASPERGER's syndrome" and resists that things attempt that causes that VARIK not uses "ASPERGER's syndrome".  That (VARIK uses (for describing VARIK) "ASPERGER's syndrome") continues.
